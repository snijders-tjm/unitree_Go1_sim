...
int main(int argc, char **argv)
{
    ...
    ros::init(argc, argv, "ex_Tommy");
    ros::NodeHandle nh;
    ros::Publisher ex_Tommy = nh.advertise<gazebo_msgs::ModelState>("/gazebo/set_model_state", 1000);
    ...
    {
        model_state_pub.twist.linear.x= 0.0; //0.02: 2cm/sec
        model_state_pub.twist.linear.y= 0.0;
        model_state_pub.twist.linear.z= 0.0;
        
        model_state_pub.twist.angular.x= 0.2;
