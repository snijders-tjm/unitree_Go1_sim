...
//    void baseStateCallback(const geometry_msgs::Pose& msg)
//    {
//        basePos.x = msg.position.x;
//        basePos.y = msg.position.y;
//        basePos.z = msg.position.z;
//    }
...
//    robot_state.model_name = robot_name + "_gazebo";
