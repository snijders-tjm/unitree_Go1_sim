...
#define MAX_X_VELOCITY 0.011
#define MAX_YAW_RATE 0.15
#define Z_LEG_LIFT 0.14
#define Z_ERROR_CONSTANT 0.02
#define BODY_SHIFT_Y 0.06
...
void CrawlGaitController::updateVelCommand(const geometry_msgs::Twist::ConstPtr& msg,
...
Eigen::Matrix<float, 3, 4> CrawlGaitController::run(State& state,
    ...
    std::cout << "NU IN run VAN CrawlGaitController \n";
