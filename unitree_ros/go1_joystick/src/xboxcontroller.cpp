...
///////////////////////////////////////////////////////////////////////////////
void xbox_controller::callback(const sensor_msgs::Joy::ConstPtr& msg)
{
//    float lim = 0.2f;
//    for (int i=0; i < (sizeof(target_joy.axes)); i++){
//        target_joy.axes[i] = msg->axes[i] * lim;
//    }
...
///////////////////////////////////////////////////////////////////////////////
float xbox_controller::ramped_vel(float v_prev, float v_target,
...
///////////////////////////////////////////////////////////////////////////////
sensor_msgs::Joy xbox_controller::get_message()
{
    return last_joy;
}
